  ...
  server.registerTool(
    "ttctl_applications_interview_show",
    {
      ...
      description: [
        ...
        "",
        "The job carries its title plus ids (job id + activity-item id). For the full job context",
        "(skills, client, languages, …) call `ttctl_applications_show` with the activity-item id.",
        "",
