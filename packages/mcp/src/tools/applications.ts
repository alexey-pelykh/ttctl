  ...
  server.registerTool(
    "ttctl_applications_interview_show",
    {
      ...
      description: [
        ...
        "",
        "The job is trimmed to ids here (job id + activity-item id). For the full job context",
        "(title, skills, client, languages, …) call `ttctl_applications_show` with the activity-item id.",
        "",
  ...
  server.registerTool(
    "ttctl_applications_interview_notes_show",
    {
      ...
      description: [
        ...
        "",
        "Only the prep notes are returned — the interview detail is trimmed. For the full",
        "interview detail (time, contacts, method, job) call `ttctl_applications_interview_show`",
        "with the interview id.",
        "",
        "Example user prompts:",
  ...
  server.registerTool(
    "ttctl_applications_interview_guide_show",
    {
      ...
      description: [
        ...
        "",
        "Only the guide content is returned — the interview detail (time, contacts, job,",
        "client) is trimmed. For it, call `ttctl_applications_interview_show` with the interview id.",
        "",
        "Example user prompts:",
