  ...
  server.registerTool(
    "ttctl_profile_employment_list",
    {
      ...
      description: [
        ...
        "",
        "Each row also hydrates `employer` — the resolved employer-catalog card (`name`, `city`, `country`, `logoUrl`, `employeeCount`, `industries`), or null for custom (non-catalog) workplaces — #555.",
        "",
        ...
        '  - "How big are the companies I have worked at, and where are they based?"',
      ].join("\n"),
