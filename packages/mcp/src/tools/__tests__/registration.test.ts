...
const EXPECTED_TOOLS = [
  ...
  // jobs (#148 / #436 / #471 / #472 / #473 / #479) — 24 tools: browse (list /
  // show / show-many / recommended / dashboard / dashboard-count / match-quality),
  // interest + search subscription, and the apply funnel (apply + apply_data /
  // _questions / _rate_insight / _similar_answers). Per AC: MCP names use
  // canonical `jobs_*` prefix only — no `opportunities_*`.
  "ttctl_jobs_list",
