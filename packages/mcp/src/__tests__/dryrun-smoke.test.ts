...
const TOOL_INPUT_FIXTURES: Record<string, Record<string, unknown>> = {
  ...
  ttctl_engagements_payments_list: { id: "job_123" },
  ...
  ttctl_jobs_dashboard_count: { statusGroup: "ACTIVE_ENGAGEMENT" },
  ttctl_jobs_list: {},
  ttctl_jobs_mark_viewed: { id: "job_123" },
  ttctl_jobs_match_quality: { id: "job_123" },
  ttctl_jobs_not_interested: { id: "job_123", reason: "schedule" },
  ttctl_jobs_not_interested_list: {},
  ttctl_jobs_rate_insight: { id: "job_123" },
  ...
  ttctl_jobs_show_many: { ids: ["job_123", "job_456"] },
  ...
  // surveys (3 — #672/#673/#674; all dry-run paths are zero-transport)
  ...
  // me (1 — #389; read-only, all args optional → empty fixture)
  ttctl_me_actions_list: {},
  // timesheet (5 — #13 + #374 pending_list + #458 update)
  ttctl_timesheet_list: {},
  ttctl_timesheet_pending_list: {},
  ttctl_timesheet_show: { id: "bc_123" },
  ttctl_timesheet_show_many: { ids: ["bc_123", "bc_456"] },
  ttctl_timesheet_submit: { id: "bc_123" },
  ttctl_timesheet_update: { id: "bc_123", comment: "smoke" },
  ...
  ttctl_payments_show_many: { ids: ["pmt_123"] },
...
describe("MCP tools — dryRun smoke test (#165)", () => {
  ...
  it("registers exactly 140 tools (sanity for the smoke loop)", () => {
    expect(Object.keys(tools)).toHaveLength(140);
  });
