...
export type TalentBadgesQuery = { viewer: { __typename: 'Viewer', id: string, badgeGroups: { __typename: 'BadgeGroupConnection', nodes: Array<{ __typename: 'BadgeGroup', id: string, order: number | null, badges: { __typename: 'BadgeConnection', nodes: Array<{ __typename: 'Badge', id: string, achievedAt: unknown, animation: string, backgroundGradientBottom: string, backgroundGradientTop: string, celebrationText: string, image: string, level: number, longDescription: string, name: string, progress: number | null } | null> } } | null> }, talentStatistics: { __typename: 'RoleStatistics', id: string, hoursWorked: number, successfulEngagements: number, totalEarnings: number, yearsInToptal: number } } | null };

export type BadgeDataFragment = { __typename: 'Badge', id: string, achievedAt: unknown, animation: string, backgroundGradientBottom: string, backgroundGradientTop: string, celebrationText: string, image: string, level: number, longDescription: string, name: string, progress: number | null };
